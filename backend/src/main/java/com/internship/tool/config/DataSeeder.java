...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedMeetingMinutes() {
        // Check for non-deleted records instead of total count
        long activeRecords = meetingMinutesRepository.countByIsDeletedFalse();
        
        if (activeRecords == 0) {
            log.info("No active meeting minutes found, seeding data...");
            List<MeetingMinutes> meetings = List.of(
                ...
                MeetingMinutes.builder()
                    ...
                    .status("PUBLISHED").isDeleted(false).createdBy("admin").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("PUBLISHED").isDeleted(false).createdBy("john.doe").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("PUBLISHED").isDeleted(false).createdBy("sarah.smith").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("DRAFT").isDeleted(false).createdBy("admin").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("DRAFT").isDeleted(false).createdBy("john.doe").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("DRAFT").isDeleted(false).createdBy("sarah.smith").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("ARCHIVED").isDeleted(false).createdBy("admin").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("ARCHIVED").isDeleted(false).createdBy("john.doe").build(),
                ...
                MeetingMinutes.builder()
                    ...
                    .status("ARCHIVED").isDeleted(false).createdBy("sarah.smith").build(),
